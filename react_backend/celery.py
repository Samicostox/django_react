...
from react_backend import settings  # Ensure this is the correct import for your settings module
...
# Optional: Define a task that will print the message "hello" to the console
@app.task(bind=True)
def debug_task(self):
