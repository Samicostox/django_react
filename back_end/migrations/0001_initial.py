# Generated by Django 4.0.6 on 2023-09-22 10:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('functional_titles', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default='Authentication Pages', max_length=200), blank=True, default=list, size=None)),
                ('functional_requirements', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default='The web app must allow users to register and login using email and password.', max_length=500), blank=True, default=list, size=None), blank=True, default=list, size=None)),
                ('non_functional_titles', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default='Reliability', max_length=200), blank=True, default=list, size=None)),
                ('non_functional_requirements', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(default='The web app must have a minimum uptime of 99.99%.', max_length=500), blank=True, default=list, size=None), blank=True, default=list, size=None)),
